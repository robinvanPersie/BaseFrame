package com.antimage.basemodule.ui.fragment.dialog;
...
import com.antimage.basemodule.databinding.BaseFragmentDialogUpdateBinding;
import com.antimage.basemodule.ui.fragment.BaseDialogFragment;
...
public class AppUpdateDialogFragment extends BaseDialogFragment {
    ...
    private BaseFragmentDialogUpdateBinding binding;
    private Builder builder;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.base_fragment_dialog_update, container, false);
