package com.antimage.basemodule.image;
...
import com.antimage.basemodule.core.GlideApp;
import com.antimage.basemodule.utils.android.DeviceUtils;
...
public class ImageLoader {
    ...
    public static void loadRoundIcon(Context context, String url, ImageView imageView,
        ...
        GlideApp.with(context).load(url)
                .transform(new RoundedCornersTransformation(context,size / 2, 0, cornerType))
                .override(size)
                .placeholder(placeholder)
                .into(imageView);
    }
